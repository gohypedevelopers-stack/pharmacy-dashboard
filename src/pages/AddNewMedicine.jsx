...
function AddNewMedicine() {
                ...
                <div className="grid gap-4 md:grid-cols-[2fr,1.2fr] items-start">
                  <Field label="Medicine Image (optional)">
                    ...
                    <p className="mt-1 text-[11px] text-slate-400">
                      Upload a clear image of the medicine pack or strip.
                    </p>
                  </Field>
  ...
  <div className="relative">
    ...
    <input
      ...
      onChange={(e) => {
        ...
        setFormData((prev) => ({
          ...prev,
          strengthValue: value,
          strength: (value ? `${value} ${prev.strengthUnit || "mg"}` : "")
        }));
      }}
      placeholder="500"
    ...
    {/* Unit dropdown inside the same field */}
    <select
      name="strengthUnit"
      ...
      onChange={(e) => {
        ...
        setFormData((prev) => ({
          ...prev,
          strengthUnit: unit,
          strength: (prev.strengthValue ? `${prev.strengthValue} ${unit}` : "")
        }));
      }}
